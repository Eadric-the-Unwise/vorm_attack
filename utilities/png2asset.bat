...
@REM C:\c_code\gbdk\bin\png2asset res\tiles\bullet.png -sw 16 -sh 16 -sp -spr8x16 -b 1 
C:\c_code\gbdk\bin\png2asset res\tiles\galaga.png -sw 16 -sh 16 -sp -spr8x16 -b 1 0x10 -keep_palette_order
